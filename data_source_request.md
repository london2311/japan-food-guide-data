...
![Release](https://img.shields.io/github/v/release/london2311/japan-food-guide-data)
![License](https://img.shields.io/github/license/london2311/japan-food-guide-data)
![Issues](https://img.shields.io/github/issues/london2311/japan-food-guide-data)
...
This project is prepared as an active open-source maintenance project:

- Public repository: https://github.com/london2311/japan-food-guide-data
- Initial versioned release: `v0.1.0`
- Issue templates for bugs, features, and data-source requests
- Roadmap and planned maintenance tasks
- GitHub Actions workflow for automated collection
- Tests for the sample collector
- Responsible-use documentation for public web data collection

Codex would be used for pull request review, issue triage, collector implementation, test generation, schema validation, release workflow improvements, documentation maintenance, and security/responsible-use checks.
